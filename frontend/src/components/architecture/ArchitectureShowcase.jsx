...
import { FiGitCommit, FiServer, FiBox } from 'react-icons/fi'
...
const STEPS = [
  ...
  { label: 'Build & Push', detail: 'Docker Hub images :sha' },
  { label: 'Update Infra Repo', detail: 'sed image tag commit' },
  ...
  return (
    <ScrollReveal>
      <section id="architecture">
        <SectionHeading badge="system">Architecture</SectionHeading>
